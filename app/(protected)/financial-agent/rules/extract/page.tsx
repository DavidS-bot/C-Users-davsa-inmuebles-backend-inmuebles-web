    ...
    <div className="space-y-6">
      ...
      <div>
        <nav className="text-sm text-gray-500 mb-2">
          ...
          <a href="/financial-agent/rules" className="hover:text-blue-600">Reglas</a>
          <span className="mx-2">&gt;</span>
          <span>Extraer Conceptos</span>
        </nav>
        <h1 className="text-3xl font-bold text-gray-900">📋 Crear Reglas desde Extracto</h1>
        <p className="text-gray-600 mt-1">Extrae conceptos del extracto bancario para crear reglas de clasificación</p>
      </div>
