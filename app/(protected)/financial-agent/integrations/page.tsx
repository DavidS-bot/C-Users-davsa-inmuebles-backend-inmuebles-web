  ...
  return (
    <div className="min-h-screen p-8 space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4 gradient-text">Integraciones Externas</h1>
        <p className="text-gray-600 text-lg">Conecta con bancos, mercados y servicios externos</p>
      </div>
