  ...
  return (
    <div className="min-h-screen p-8 space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4 gradient-text">Integración con Bankinter</h1>
        <p className="text-gray-600 text-lg">Conecta tu cuenta de Bankinter para descargar extractos automáticamente</p>
      </div>
