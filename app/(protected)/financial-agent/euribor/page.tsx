      ...
      <div className="flex justify-between items-center">
        <div>
          <nav className="text-sm text-gray-500 mb-2">
            ...
            <span>Tasas Euribor</span>
          </nav>
          <h1 className="text-3xl font-bold text-gray-900">📈 Gestión de Tasas Euribor</h1>
          <p className="text-gray-600 mt-1">Administra las tasas históricas del Euribor para cálculos de hipotecas</p>
        </div>
